...
const announcementActionText = document.getElementById('announcementActionText');
const announcementActionUrl  = document.getElementById('announcementActionUrl');
const announcementExpiresAt  = document.getElementById('announcementExpiresAt');
const announcementSendEmail  = document.getElementById('announcementSendEmail');
const announcementRoleCheckboxes = Array.from(document.querySelectorAll('[data-announcement-role]'));
const announcementRecipientSearch = document.getElementById('announcementRecipientSearch');
const announcementRecipientRoleFilter = document.getElementById('announcementRecipientRoleFilter');
const announcementRecipientRetryBtn = document.getElementById('announcementRecipientRetryBtn');
const announcementRecipientList = document.getElementById('announcementRecipientList');
const announcementRecipientEmpty = document.getElementById('announcementRecipientEmpty');
const announcementSelectedRecipients = document.getElementById('announcementSelectedRecipients');
const announcementSelectedCount = document.getElementById('announcementSelectedCount');
const announcementPreviewPriority = document.getElementById('announcementPreviewPriority');
const announcementPreviewTitle = document.getElementById('announcementPreviewTitle');
const announcementPreviewBody = document.getElementById('announcementPreviewBody');
const announcementPreviewAction = document.getElementById('announcementPreviewAction');
const announcementPreviewExpiry = document.getElementById('announcementPreviewExpiry');
const announcementPreviewDelivery = document.getElementById('announcementPreviewDelivery');
const announcementPreviewRecipients = document.getElementById('announcementPreviewRecipients');
const announcementMessage = document.getElementById('announcementMessage');
const announcementPublishBtn = document.getElementById('announcementPublishBtn');
const announcementHistoryList = document.getElementById('announcementHistoryList');
const announcementHistoryMessage = document.getElementById('announcementHistoryMessage');
const announcementHistoryRetryBtn = document.getElementById('announcementHistoryRetryBtn');
const announcementHistoryRefreshBtn = document.getElementById('announcementHistoryRefreshBtn');
const announcementHistoryLoadMoreBtn = document.getElementById('announcementHistoryLoadMoreBtn');
