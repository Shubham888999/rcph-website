...
- Root page-specific CSS/JS: `css/access.css`, `js/access.js`, `css/my-dashboard.css`, `js/my-dashboard.js`, `css/madhushala.css`, `js/dzrvisit.js`, `admin.js`, `css/mobile.css`, `css/style.css`, `js/script.js`, `js/firebase-init.js`, `router.js`.
