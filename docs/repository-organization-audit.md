...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `.firebaserc` | Firebase project config | Firebase project alias/config used by CLI. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json` | Yes | .firebaserc | High | Tracked |
| `.gitignore` | Git ignore config | Git ignore policy for dependencies, env files, reports, logs, and caches. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Yes | .gitignore | High | Tracked |
...
| `about.html` | HTML page | Root public or internal HTML route with production URL impact. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
...
| `admin.html` | HTML page | Admin page or legacy/admin JavaScript asset. | `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `admin.js` | JavaScript | Admin page or legacy/admin JavaScript asset. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md` | Needs investigation | internal-apps/<page>/admin.js | Medium | Tracked |
| `bod.html` | HTML page | Root public or internal HTML route with production URL impact. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `CNAME` | Config | Custom domain file, relevant for static-hosting compatibility and source history. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md` | Yes | CNAME | High | Tracked |
...
| `firebase-init.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `firebase.json` | JSON/config | Firebase CLI config for Functions, Firestore rules/indexes, and Hosting. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md` | Yes | firebase.json | High | Tracked |
...
| `index.html` | HTML page | Public home page served at /. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `README.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md` | Yes | index.html | High | Tracked |
...
| `login.html` | HTML page | Root public or internal HTML route with production URL impact. | `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `madhushala.css` | CSS | Stylesheet referenced by root or internal pages. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `madhushala.html` | Needs investigation | css/ or js/ with reference updates | Medium | Tracked |
| `madhushala.html` | HTML page | Root public or internal HTML route with production URL impact. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `mobile.css` | CSS | Stylesheet referenced by root or internal pages. | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `my-dashboard.css` | CSS | Member/prospect dashboard page or asset. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `my-dashboard.html` | Needs investigation | internal-apps/<page>/my-dashboard.css | Medium | Tracked |
| `my-dashboard.html` | HTML page | Member/prospect dashboard page or asset. | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `my-dashboard.js` | JavaScript | Member/prospect dashboard page or asset. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/07-implementation-phases.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md` | Needs investigation | internal-apps/<page>/my-dashboard.js | Medium | Tracked |
| `package-lock.json` | JSON/config | Root npm lockfile for frontend tooling. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json` | Yes | package-lock.json | High | Tracked |
| `package.json` | JSON/config | Root frontend build tooling and dependency manifest. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/README.md`, `firebase.json` | Yes | package.json | High | Tracked |
...
| `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md` | Documentation | Historical repository cleanup/audit note. | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | No | docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md | Medium | Tracked |
| `projects.html` | HTML page | Root public or internal HTML route with production URL impact. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `README.md` | Documentation | Repository documentation/audit note. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/riy-clean-slate/README.md`, `docs/visit-submission-system/README.md` | Needs investigation | docs/archive/README.md | Medium | Tracked |
| `robots.txt` | Text/SEO | Crawler policy and sitemap pointer served from web root. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Yes | robots.txt | High | Tracked |
...
| `router.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `functions/lib/riy-clean-slate.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json` | Needs investigation | css/ or js/ with reference updates | Medium | Tracked |
| `script.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `site.webmanifest` | Web manifest | Web app manifest referenced by public pages. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html` | Yes | site.webmanifest | High | Tracked |
| `sitemap.xml` | SEO XML | Public sitemap served from web root. | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt` | Yes | sitemap.xml | High | Tracked |
| `style.css` | CSS | Stylesheet referenced by root or internal pages. | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
...
- `.firebaserc`: Yes. Firebase project alias/config used by CLI. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json`.
- `.gitignore`: Yes. Git ignore policy for dependencies, env files, reports, logs, and caches. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`.
...
- `about.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml`.
...
- `admin.html`: Probably yes. Admin page or legacy/admin JavaScript asset. Inbound references found from `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `llms.txt`, `login.html`, `my-dashboard.html`, `robots.txt`, `router.js`, `scripts/verify-visit-submission-ui.js`.
- `bod.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml`.
- `CNAME`: Yes. Custom domain file, relevant for static-hosting compatibility and source history. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`.
...
- `firebase-init.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `dzrvisit.html`, `login.html`, `my-dashboard.html`, `visit-submissions.html`.
- `firebase.json`: Yes. Firebase CLI config for Functions, Firestore rules/indexes, and Hosting. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`.
...
- `index.html`: Yes. Public home page served at /. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `README.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `join.html`, `js/public-animations.js`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `tailwind.config.js`.
...
- `login.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js`, `admin/js/admin-core.js`, `admin/js/admin-init.js`, `bod.html`, `contact.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `js/visit-submissions.js`, `llms.txt`, `my-dashboard.html`, `my-dashboard.js`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `robots.txt`, `router.js`.
- `madhushala.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml`.
- `mobile.css`: Probably yes. Stylesheet referenced by root or internal pages. Inbound references found from `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html`.
- `my-dashboard.html`: Probably yes. Member/prospect dashboard page or asset. Inbound references found from `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `robots.txt`.
- `package-lock.json`: Yes. Root npm lockfile for frontend tooling. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json`.
- `package.json`: Yes. Root frontend build tooling and dependency manifest. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/README.md`, `firebase.json`.
...
- `projects.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `sitemap.xml`.
- `robots.txt`: Yes. Crawler policy and sitemap pointer served from web root. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`.
- `rotary_wheel.png`: Probably yes. Image/icon asset Inbound references found from `docs/repository-audit/01-file-inventory.md`.
- `script.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`.
- `site.webmanifest`: Yes. Web app manifest referenced by public pages. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html`.
- `sitemap.xml`: Yes. Public sitemap served from web root. Inbound references found from `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt`.
- `style.css`: Probably yes. Stylesheet referenced by root or internal pages. Inbound references found from `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `visit-submissions.html`.
...
| --- | --- | --- | --- | --- | --- | --- |
| `about.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `admin.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `llms.txt`, `login.html`, `my-dashboard.html`, `robots.txt`, `router.js`, `scripts/verify-visit-submission-ui.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `admin.js` | `internal-apps/<page>/admin.js` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `bod.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `firebase-init.js` | `css/ or js/ with reference updates` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `dzrvisit.html`, `login.html`, `my-dashboard.html`, `visit-submissions.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `login.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js`, `admin/js/admin-core.js`, `admin/js/admin-init.js`, `bod.html`, `contact.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `js/visit-submissions.js`, `llms.txt`, `my-dashboard.html`, `my-dashboard.js`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `robots.txt`, `router.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `madhushala.css` | `css/ or js/ with reference updates` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `madhushala.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `madhushala.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `mobile.css` | `css/ or js/ with reference updates` | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `my-dashboard.css` | `internal-apps/<page>/my-dashboard.css` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `my-dashboard.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `my-dashboard.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `robots.txt` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md` | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | None; archived docs are ignored by Hosting. | No direct Firebase config impact found | Yes | Already archived in Phase 2B; retain unless manually approved for deletion. |
| `projects.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `README.md` | `docs/archive/README.md` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/riy-clean-slate/README.md`, `docs/visit-submission-system/README.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `router.js` | `css/ or js/ with reference updates` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `functions/lib/riy-clean-slate.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `script.js` | `css/ or js/ with reference updates` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `style.css` | `css/ or js/ with reference updates` | `BOD Event manager/bodlogin.html`, `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `visit-submissions.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
...
| `_archive/assets-review/group - Copy.jpeg` | `_archive/assets-review/group - Copy.jpeg` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/assets-review/logo3.jpg.jpeg` | `_archive/assets-review/logo3.jpg.jpeg` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/old-pages/gifc.html` | `_archive/old-pages/gifc.html` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
...
| `fragments/calendar.html` | `public/fragments/calendar.html (only if fetch paths are updated)` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `fragments/projects.html` | `public/fragments/projects.html (only if fetch paths are updated)` | `docs/archive/PROJECT_CLEANUP_REPORT-2026-05-26.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
