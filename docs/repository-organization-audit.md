...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `.firebaserc` | Firebase project config | Firebase project alias/config used by CLI. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json` | Yes | .firebaserc | High | Tracked |
| `.gitignore` | Git ignore config | Git ignore policy for dependencies, env files, reports, logs, and caches. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Yes | .gitignore | High | Tracked |
...
| `about.html` | HTML page | Root public or internal HTML route with production URL impact. | `PROJECT_CLEANUP_REPORT.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `access.css` | CSS | Access Hub page or asset. | `access.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md` | Needs investigation | internal-apps/<page>/access.css | Medium | Tracked |
| `access.html` | HTML page | Access Hub page or asset. | `BOD Event manager/bodlogin.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `access.js` | JavaScript | Access Hub page or asset. | `access.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/07-implementation-phases.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md` | Needs investigation | internal-apps/<page>/access.js | Medium | Tracked |
| `admin.html` | HTML page | Admin page or legacy/admin JavaScript asset. | `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `admin.js` | JavaScript | Admin page or legacy/admin JavaScript asset. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md` | Needs investigation | internal-apps/<page>/admin.js | Medium | Tracked |
| `bod.html` | HTML page | Root public or internal HTML route with production URL impact. | `PROJECT_CLEANUP_REPORT.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `CNAME` | Config | Custom domain file, relevant for static-hosting compatibility and source history. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md` | Yes | CNAME | High | Tracked |
| `contact.html` | HTML page | Root public or internal HTML route with production URL impact. | `about.html`, `bod.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `dzrvisit.html` | HTML page | DZR visit page or script. | `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `admin.js`, `admin/js/admin-core.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `dzrvisit.js` | JavaScript | DZR visit page or script. | `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md` | Needs investigation | internal-apps/<page>/dzrvisit.js | Medium | Tracked |
| `events.html` | HTML page | Root public or internal HTML route with production URL impact. | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `faq.html` | HTML page | Root public or internal HTML route with production URL impact. | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `firebase-init.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `PROJECT_CLEANUP_REPORT.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `firebase.json` | JSON/config | Firebase CLI config for Functions, Firestore rules/indexes, and Hosting. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md` | Yes | firebase.json | High | Tracked |
| `firestore.indexes.json` | JSON/config | Firestore composite index definitions deployed by Firebase CLI. | `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submissions/01-backend-foundation.md`, `docs/visit-submissions/06-security-and-limits.md`, `firebase.json` | Yes | firestore.indexes.json | High | Tracked |
| `firestore.rules` | Firestore rules | Firestore security rules deployed by Firebase CLI. | `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md` | Yes | firestore.rules | High | Tracked |
| `index.html` | HTML page | Public home page served at /. | `PROJECT_CLEANUP_REPORT.md`, `README.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md` | Yes | index.html | High | Tracked |
| `join.html` | HTML page | Root public or internal HTML route with production URL impact. | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `llms.txt` | Text/SEO | AI-friendly public site summary served from web root. | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt` | Yes | llms.txt | High | Tracked |
| `login.html` | HTML page | Root public or internal HTML route with production URL impact. | `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `madhushala.css` | CSS | Stylesheet referenced by root or internal pages. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `madhushala.html` | Needs investigation | css/ or js/ with reference updates | Medium | Tracked |
| `madhushala.html` | HTML page | Root public or internal HTML route with production URL impact. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `mobile.css` | CSS | Stylesheet referenced by root or internal pages. | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `my-dashboard.css` | CSS | Member/prospect dashboard page or asset. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `my-dashboard.html` | Needs investigation | internal-apps/<page>/my-dashboard.css | Medium | Tracked |
| `my-dashboard.html` | HTML page | Member/prospect dashboard page or asset. | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `my-dashboard.js` | JavaScript | Member/prospect dashboard page or asset. | `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/07-implementation-phases.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md` | Needs investigation | internal-apps/<page>/my-dashboard.js | Medium | Tracked |
| `package-lock.json` | JSON/config | Root npm lockfile for frontend tooling. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json` | Yes | package-lock.json | High | Tracked |
| `package.json` | JSON/config | Root frontend build tooling and dependency manifest. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/README.md`, `firebase.json` | Yes | package.json | High | Tracked |
| `position-migration-report.zip` | Archive/report artifact | Generated migration/report artifact. | Direct URL/config/none found | No | reports/archive/position-migration-report.zip | Low | Tracked |
| `postcss.config.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `PROJECT_CLEANUP_REPORT.md` | Documentation | Repository documentation/audit note. | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | No | docs/archive/PROJECT_CLEANUP_REPORT.md | Medium | Tracked |
| `projects.html` | HTML page | Root public or internal HTML route with production URL impact. | `PROJECT_CLEANUP_REPORT.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |
| `README.md` | Documentation | Repository documentation/audit note. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/riy-clean-slate/README.md`, `docs/visit-submission-system/README.md` | Needs investigation | docs/archive/README.md | Medium | Tracked |
| `robots.txt` | Text/SEO | Crawler policy and sitemap pointer served from web root. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Yes | robots.txt | High | Tracked |
| `rotary_wheel.png` | Image/icon asset | Image/icon asset | `docs/repository-audit/01-file-inventory.md` | Probably yes | images/rotary_wheel.png after reference updates | Medium | Tracked |
| `router.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `functions/lib/riy-clean-slate.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json` | Needs investigation | css/ or js/ with reference updates | Medium | Tracked |
| `script.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `site.webmanifest` | Web manifest | Web app manifest referenced by public pages. | `PROJECT_CLEANUP_REPORT.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html` | Yes | site.webmanifest | High | Tracked |
| `sitemap.xml` | SEO XML | Public sitemap served from web root. | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt` | Yes | sitemap.xml | High | Tracked |
| `style.css` | CSS | Stylesheet referenced by root or internal pages. | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `tailwind.config.js` | JavaScript | Browser JavaScript referenced by pages or Firebase workflows. | `css/tailwind-input.css`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Probably yes | css/ or js/ with reference updates | Medium | Tracked |
| `visit-submissions.html` | HTML page | Club Visits / Visit Submission UI entry point. | `access.js`, `admin.html`, `docs/visit-submissions/07-frontend-ui.md`, `js/visit-submission-state.js`, `scripts/verify-visit-http-upload-ui.js`, `scripts/verify-visit-submission-ui.js` | Probably yes | Keep current URL; only move later with Hosting rewrites/redirect plan. | High | Tracked |

## 3. Root Files That Must Remain
These are confirmed from the actual repository, not assumed.
- `.firebaserc`: Yes. Firebase project alias/config used by CLI. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json`.
- `.gitignore`: Yes. Git ignore policy for dependencies, env files, reports, logs, and caches. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`.
...
- `about.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml`.
- `access.html`: Probably yes. Access Hub page or asset. Inbound references found from `BOD Event manager/bodlogin.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `js/visit-submissions.js`, `login.html`, `my-dashboard.html`, `robots.txt`, `visit-submissions.html`.
- `admin.html`: Probably yes. Admin page or legacy/admin JavaScript asset. Inbound references found from `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `llms.txt`, `login.html`, `my-dashboard.html`, `robots.txt`, `router.js`, `scripts/verify-visit-submission-ui.js`.
- `bod.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml`.
- `CNAME`: Yes. Custom domain file, relevant for static-hosting compatibility and source history. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`.
- `contact.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `about.html`, `bod.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `projects.html`, `sitemap.xml`.
- `dzrvisit.html`: Probably yes. DZR visit page or script. Inbound references found from `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `admin.js`, `admin/js/admin-core.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `login.html`, `robots.txt`.
- `events.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `sitemap.xml`.
- `faq.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml`.
- `firebase-init.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `dzrvisit.html`, `login.html`, `my-dashboard.html`, `visit-submissions.html`.
- `firebase.json`: Yes. Firebase CLI config for Functions, Firestore rules/indexes, and Hosting. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`.
- `firestore.indexes.json`: Yes. Firestore composite index definitions deployed by Firebase CLI. Inbound references found from `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submissions/01-backend-foundation.md`, `docs/visit-submissions/06-security-and-limits.md`, `firebase.json`.
- `firestore.rules`: Yes. Firestore security rules deployed by Firebase CLI. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `firebase.json`, `functions/lib/riy-clean-slate.js`, `functions/scripts/verify-visit-http-upload.js`, `functions/scripts/verify-visit-submission-foundation.js`, `functions/scripts/verify-visit-submission-upload-lifecycle.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`.
- `index.html`: Yes. Public home page served at /. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `README.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `join.html`, `js/public-animations.js`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `tailwind.config.js`.
- `join.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `llms.txt`, `madhushala.html`, `projects.html`, `sitemap.xml`.
- `llms.txt`: Yes. AI-friendly public site summary served from web root. Inbound references found from `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt`.
- `login.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js`, `admin/js/admin-core.js`, `admin/js/admin-init.js`, `bod.html`, `contact.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `js/visit-submissions.js`, `llms.txt`, `my-dashboard.html`, `my-dashboard.js`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `robots.txt`, `router.js`.
- `madhushala.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml`.
- `mobile.css`: Probably yes. Stylesheet referenced by root or internal pages. Inbound references found from `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html`.
- `my-dashboard.html`: Probably yes. Member/prospect dashboard page or asset. Inbound references found from `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `robots.txt`.
- `package-lock.json`: Yes. Root npm lockfile for frontend tooling. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `firebase.json`.
- `package.json`: Yes. Root frontend build tooling and dependency manifest. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/README.md`, `firebase.json`.
- `postcss.config.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`.
- `projects.html`: Probably yes. Root public or internal HTML route with production URL impact. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `sitemap.xml`.
- `robots.txt`: Yes. Crawler policy and sitemap pointer served from web root. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`.
- `rotary_wheel.png`: Probably yes. Image/icon asset Inbound references found from `docs/repository-audit/01-file-inventory.md`.
- `script.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`.
- `site.webmanifest`: Yes. Web app manifest referenced by public pages. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html`.
- `sitemap.xml`: Yes. Public sitemap served from web root. Inbound references found from `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`, `robots.txt`.
- `style.css`: Probably yes. Stylesheet referenced by root or internal pages. Inbound references found from `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `visit-submissions.html`.
- `tailwind.config.js`: Probably yes. Browser JavaScript referenced by pages or Firebase workflows. Inbound references found from `css/tailwind-input.css`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md`.
- `visit-submissions.html`: Probably yes. Club Visits / Visit Submission UI entry point. Inbound references found from `access.js`, `admin.html`, `docs/visit-submissions/07-frontend-ui.md`, `js/visit-submission-state.js`, `scripts/verify-visit-http-upload-ui.js`, `scripts/verify-visit-submission-ui.js`.
...
| --- | --- | --- | --- | --- | --- | --- |
| `about.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `PROJECT_CLEANUP_REPORT.md`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `access.css` | `internal-apps/<page>/access.css` | `access.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `access.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `js/visit-submissions.js`, `login.html`, `my-dashboard.html`, `robots.txt`, `visit-submissions.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `access.js` | `internal-apps/<page>/access.js` | `access.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/07-implementation-phases.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `scripts/verify-visit-submission-ui.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `admin.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `llms.txt`, `login.html`, `my-dashboard.html`, `robots.txt`, `router.js`, `scripts/verify-visit-submission-ui.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `admin.js` | `internal-apps/<page>/admin.js` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `bod.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `PROJECT_CLEANUP_REPORT.md`, `about.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `contact.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `about.html`, `bod.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `dzrvisit.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `admin.js`, `admin/js/admin-core.js`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/02-position-and-role-map.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `login.html`, `robots.txt` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `dzrvisit.js` | `internal-apps/<page>/dzrvisit.js` | `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/README.md`, `dzrvisit.html`, `functions/lib/riy-clean-slate.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `events.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `faq.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `index.html`, `join.html`, `llms.txt`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `firebase-init.js` | `css/ or js/ with reference updates` | `PROJECT_CLEANUP_REPORT.md`, `access.html`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `dzrvisit.html`, `login.html`, `my-dashboard.html`, `visit-submissions.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `join.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `llms.txt`, `madhushala.html`, `projects.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `login.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.html`, `BOD Event manager/bodlogin.js`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `access.js`, `admin.html`, `admin.js`, `admin/js/admin-core.js`, `admin/js/admin-init.js`, `bod.html`, `contact.html`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `dzrvisit.js`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `functions/lib/riy-clean-slate.js`, `index.html`, `join.html`, `js/visit-submissions.js`, `llms.txt`, `my-dashboard.html`, `my-dashboard.js`, `projects.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json`, `robots.txt`, `router.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `madhushala.css` | `css/ or js/ with reference updates` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `madhushala.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `madhushala.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `llms.txt`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `mobile.css` | `css/ or js/ with reference updates` | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `events.html`, `faq.html`, `index.html`, `join.html`, `madhushala.html`, `projects.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `my-dashboard.css` | `internal-apps/<page>/my-dashboard.css` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/README.md`, `my-dashboard.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `my-dashboard.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `access.js`, `admin.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/03-security-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/06-ui-and-page-plan.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `llms.txt`, `robots.txt` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `my-dashboard.js` | `internal-apps/<page>/my-dashboard.js` | `PROJECT_CLEANUP_REPORT.md`, `docs/multi-position-role-system/01-current-assumptions.md`, `docs/multi-position-role-system/03-approval-ui-plan.md`, `docs/multi-position-role-system/07-implementation-phases.md`, `docs/multi-position-role-system/README.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/04-firebase-audit.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/visit-submission-system/01-current-system-findings.md`, `docs/visit-submission-system/07-phase-plan.md`, `docs/visit-submission-system/README.md`, `functions/lib/riy-clean-slate.js`, `my-dashboard.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `position-migration-report.zip` | `reports/archive/position-migration-report.zip` | None found by static scan | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | Needs investigation | Static scan only; verify browser flows before moving. |
| `postcss.config.js` | `css/ or js/ with reference updates` | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `PROJECT_CLEANUP_REPORT.md` | `docs/archive/PROJECT_CLEANUP_REPORT.md` | `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `projects.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `PROJECT_CLEANUP_REPORT.md`, `about.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `llms.txt`, `madhushala.html`, `sitemap.xml` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `README.md` | `docs/archive/README.md` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/riy-clean-slate/README.md`, `docs/visit-submission-system/README.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `rotary_wheel.png` | `images/rotary_wheel.png after reference updates` | `docs/repository-audit/01-file-inventory.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `router.js` | `css/ or js/ with reference updates` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `functions/lib/riy-clean-slate.js`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `script.js` | `css/ or js/ with reference updates` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `functions/lib/riy-clean-slate.js`, `index.html`, `reports/riy-clean-slate/2026-06-24_22-04-19/collection-inventory.json`, `reports/riy-clean-slate/2026-06-24_22-09-38/collection-inventory.json` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `style.css` | `css/ or js/ with reference updates` | `BOD Event manager/bodlogin.html`, `PROJECT_CLEANUP_REPORT.md`, `about.html`, `access.html`, `admin.html`, `bod.html`, `contact.html`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/06-recommended-structure.md`, `docs/repository-audit/README.md`, `dzrvisit.html`, `events.html`, `events/pages-of-hope.html`, `events/template.html`, `faq.html`, `index.html`, `join.html`, `login.html`, `madhushala.html`, `my-dashboard.html`, `projects.html`, `visit-submissions.html` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `tailwind.config.js` | `css/ or js/ with reference updates` | `css/tailwind-input.css`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/05-cleanup-candidates.md` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `visit-submissions.html` | `Keep current URL; only move later with Hosting rewrites/redirect plan.` | `access.js`, `admin.html`, `docs/visit-submissions/07-frontend-ui.md`, `js/visit-submission-state.js`, `scripts/verify-visit-http-upload-ui.js`, `scripts/verify-visit-submission-ui.js` | Possible if URL/path changes; preserve current URLs. | Hosting public root impact possible | No | Static scan only; verify browser flows before moving. |
| `_archive/animations-review/Cupcake-Baking.json` | `_archive/animations-review/Cupcake-Baking.json` | `PROJECT_CLEANUP_REPORT.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/animations-review/morning-coffee.json` | `_archive/animations-review/morning-coffee.json` | `PROJECT_CLEANUP_REPORT.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/assets-review/group - Copy.jpeg` | `_archive/assets-review/group - Copy.jpeg` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/assets-review/logo3.jpg.jpeg` | `_archive/assets-review/logo3.jpg.jpeg` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md` | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `_archive/old-pages/gifc.html` | `_archive/old-pages/gifc.html` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/01-file-inventory.md` | `docs/repository-audit/01-file-inventory.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/02-reference-map.md` | `docs/repository-audit/02-reference-map.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/03-security-audit.md` | `docs/repository-audit/03-security-audit.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/04-firebase-audit.md` | `docs/repository-audit/04-firebase-audit.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/05-cleanup-candidates.md` | `docs/repository-audit/05-cleanup-candidates.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/06-recommended-structure.md` | `docs/repository-audit/06-recommended-structure.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `docs/repository-audit/README.md` | `docs/repository-audit/README.md` | None found by static scan | None if references updated and Hosting ignores reviewed. | No direct Firebase config impact found | Needs investigation | Static scan only; verify browser flows before moving. |
| `fragments/calendar.html` | `public/fragments/calendar.html (only if fetch paths are updated)` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
| `fragments/projects.html` | `public/fragments/projects.html (only if fetch paths are updated)` | `PROJECT_CLEANUP_REPORT.md`, `docs/repository-audit/01-file-inventory.md`, `docs/repository-audit/02-reference-map.md`, `docs/repository-audit/05-cleanup-candidates.md`, `docs/repository-audit/README.md` | Possible if URL/path changes; preserve current URLs. | No direct Firebase config impact found | No | Static scan only; verify browser flows before moving. |
...
| `docs/multi-position-role-system/README.md`<br>`docs/repository-audit/README.md`<br>`docs/riy-clean-slate/README.md`<br>`docs/visit-submission-system/README.md`<br>`README.md` | Same basename in multiple locations | docs/multi-position-role-system/README.md | Filename collision; content may differ | Needs manual review | Medium |
...
| `docs/visit-submission-system/01-current-system-findings.md`<br>`docs/visit-submission-system/02-position-and-role-map.md`<br>`docs/visit-submission-system/03-firestore-schema.md`<br>`docs/visit-submission-system/04-permission-matrix.md`<br>`docs/visit-submission-system/05-upload-delete-architecture.md`<br>`docs/visit-submission-system/06-ui-and-page-plan.md`<br>`docs/visit-submission-system/07-phase-plan.md`<br>`docs/visit-submission-system/README.md`<br>`docs/visit-submissions/01-backend-foundation.md`<br>`docs/visit-submissions/02-frontend-contract.md`<br>`docs/visit-submissions/03-upload-architecture.md`<br>`docs/visit-submissions/04-submission-lifecycle.md`<br>`docs/visit-submissions/05-drive-folder-model.md`<br>`docs/visit-submissions/06-security-and-limits.md`<br>`docs/visit-submissions/07-frontend-ui.md`<br>`docs/visit-submissions/08-upload-ui-flow.md`<br>`docs/visit-submissions/09-firebase-http-uploader.md`<br>`docs/visit-submissions/10-http-upload-live-checklist.md` | visit submission docs generations | docs/visit-submission-system/01-current-system-findings.md | Name/version pattern and/or generated timestamp directories | Needs manual review | Medium |
...
| `position-migration-report.zip` | Archive/report artifact | Generated migration/report artifact. | Tracked; use git log before deletion | Medium | Search production pages, run local link checker, and inspect Firebase Hosting URLs before deletion. |
...
| --- | --- | --- | --- | --- | --- |
| Phase 1 - Documentation and inventory | This report and existing `docs/repository-audit/**`. | Low; documentation-only. | Review report, run `git status --short`. | Commit documentation-only checkpoint. | Revert the documentation commit. |
| Phase 2 - Remove obvious generated/debug artifacts | Ignored `reports/**`, root `position-migration-report.zip` after confirming it is preserved elsewhere. | Loss of historical evidence if removed too early. | Confirm generated reports are reproducible or archived; run verifier scripts related to RIY and positions. | Commit cleanup of generated artifacts only. | Restore from Git or external archive. |
| Phase 3 - Archive superseded files | `PROJECT_CLEANUP_REPORT.md`, `_archive/**`, repeated generated report snapshots. | Accidentally hiding active historical references. | Static reference scan, production URL spot checks, Git log review. | Commit archive-only move with no code reference changes. | Move files back or revert commit. |
| Phase 4 - Consolidate shared assets | Image variants, favicons, animation JSON, legacy root `rotary_wheel.png`. | Broken images, manifest icons, SEO previews. | Run local link checker; inspect homepage, events, Madhushala, dashboards. | Commit asset moves separately from code changes. | Revert asset move commit. |
...
| Phase 6 - Move page assets with reference updates | Root CSS/JS like `access.css`, `access.js`, `my-dashboard.css`, `my-dashboard.js`, `dzrvisit.js`, `madhushala.css`. | Broken pages due relative paths, auth redirects, fetches, hard-coded links. | Browser-test Access Hub, dashboards, Visit UI, DZR, admin, BOD. | Commit one feature/page at a time. | Revert page-specific commit. |
...
- Root page-specific CSS/JS: `access.css`, `access.js`, `my-dashboard.css`, `my-dashboard.js`, `madhushala.css`, `dzrvisit.js`, `admin.js`, `mobile.css`, `style.css`, `script.js`, `firebase-init.js`, `router.js`.
- Root image asset `rotary_wheel.png`, fragments, animations, and image variants.
...
- `position-migration-report.zip` if contents are represented in ignored/generated reports and no audit retention need remains.
