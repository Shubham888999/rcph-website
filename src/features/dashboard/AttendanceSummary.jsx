  ...
  return (
    <>
      <section className="member-metric-grid" aria-label="Personal attendance summary">
        <DashboardMetricCard label="My Attendance" value={value(attendance.percentage, "%")} detail="NA events excluded" />
        ...
        <DashboardMetricCard label="District Attendance" value={value(districtAttendance.percentage, "%")} />
      </section>
      <section className="member-dashboard-section">
        ...
        <p>{attendance.present ?? "Unknown"} present, {attendance.absent ?? "Unknown"} absent, {attendance.na ?? "Unknown"} NA.</p>
