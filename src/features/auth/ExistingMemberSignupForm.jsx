...
export default function ExistingMemberSignupForm(props) {
  ...
  return (
    <section className="signup-form-section">
      ...
      <p className="signup-intro">GBM access is approved automatically. BOD and Admin requests require review.</p>
      ...
      <form className="signup-form" onSubmit={(event) => { event.preventDefault(); onSubmit("password"); }} noValidate aria-busy={busy}>
        ...
        <fieldset className="signup-fieldset">
          ...
          <div className="signup-field">
            ...
            <p id="signup-role-help" className="signup-help">President and Website Director access cannot be requested here.</p>
          ...
          {form.requestedRole === "admin" ? (
            <div className="signup-field">
              ...
              <p id="signup-invite-help" className="signup-help">The server validates this private code.</p>
