    ...
    <fieldset className="signup-consents">
      ...
      <div className="signup-consent-row">
        ...
        <div>
          ...
          <label htmlFor="signup-communicationsOptIn">I would like to receive optional emails and reminders about upcoming RCPH events, activities, opportunities, and general announcements. I understand that I can withdraw this consent at any time and that declining will not affect my account, prospect application, or membership status.</label>
        </div>
      </div>
    </fieldset>
  );
