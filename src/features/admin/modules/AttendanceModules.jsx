...
export function ClubAttendanceModule({ data, lock, uid, onNotice }) {
  ...
  return <>
    <AdminModuleHeader title="Club Events & Attendance" description="Synchronized public club events with dynamic member attendance fields." />
...
export function BodOperationsModule({ data, lock, uid, onNotice }) {
  ...
  return <>
    <AdminModuleHeader title="BOD Roster, Meetings & Attendance" description="Internal BOD operations; the public leadership page remains separate." />
...
export function DistrictModule({ data, lock, uid, onNotice }) {
  ...
  return <>
    <AdminModuleHeader title="District Events & Attendance" description="District records mirrored to BOD submissions and conditionally to public events." />
