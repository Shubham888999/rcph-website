  ...
  return (
    <main className="login-page-react">
      <section className="auth-migration-card">
        <p className="login-kicker">Account registration</p>
        <h1>Signup migration is in progress</h1>
        <p>The existing RCPH signup workflow has not been moved into React yet.</p>
